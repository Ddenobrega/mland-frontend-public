    ...
    <div id="util-container" class="row">
      ...
      <div id="util-area" class="col">
        <div class="menu-item active-menu">
          ...
          <span
            >Insert and ip In the menu input below and we'll return the
            results</span
          ><br /><br />
          <span class="error">{{ err }}</span>
          <div id="ip-results" class="row">
            <div class="col">
              <span id="ip-address">Ip Address: {{ ip }}</span
              ><br /><br />
              <span id="ip-country">Country: {{ country }}</span
              ><br /><br />
              <span id="ip-City">City: {{ city }}</span
              ><br /><br />
              <span id="ip-Postal">Postal: {{ postal }}</span
              ><br /><br />
            </div>
            <div class="col">
              <span id="ip-latitude">Latitude: {{ lat }}</span
              ><br /><br />
              <span id="ip-longitude">Longitude: {{ lon }}</span
              ><br /><br />
              <span id="ip-provider">Provider: {{ provider }}</span
              ><br /><br />
              <span id="ip-timezone">Timezone: {{ tz }}</span
              ><br /><br />
            </div>
          </div>
          <br />
          <input
            ...
            id="ip-input"
          /><br />
          <button @click="sendIpData()" class="btn menu-active-btn">
            Lookup
          </button>
        </div>
      </div>
...
export default {
  ...
  mounted() {
    document.title = "MLand | Utilities";
  },
};
</script>
